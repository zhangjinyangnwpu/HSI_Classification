...
for NO_data in ['Salians']:
    ...
    result = open('result/result_for_NO_data_'+str(NO_data)+'_'+'_samplenum_'+'_'+str(k)+'_'+time+'.txt','w')
    ...
    plt1.savefig('result/confusion_matrix1_'+'_samplenum_'+'_'+str(k)+'_'+time+'.png', format='png')
    plt1.close()
